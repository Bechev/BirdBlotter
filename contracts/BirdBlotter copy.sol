...
contract BirdBlotter is ERC721, AdminControl {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        bytes memory byteString = abi.encodePacked(
            _uriComponents[0], 'Birdblotter ',  blotterName,
            _uriComponents[1], 'BirdBlotter: A 10,000 NFT Collection W/ Redeemable 1/1 Handmade IRL Blotter Art Prints 4 Every MoonBird.\n\nToken Holder Benefits: The Non Fungible Blotter Collection: A Series of 10 Limited Release IRL Blotter Art Prints Designed By Local NYC Artists.\n\nExclusively 4 BirdBlotter Holders. ',
            _uriComponents[2],_uri, blotterName, ".png",
            _uriComponents[3], _uri, blotterName, ".png",
            _uriComponents[4], '"trait_type": "Blotter Redeemed", "value":',  _blotterRedeemed[tokenId] ? '"true"' : '"false"',
            _uriComponents[5]);
