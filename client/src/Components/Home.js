...
function Home() {
    ...
    function renderUserInterface(){
        ...
        //     return<div>Drop will open on 8/8</div>
        }else{
    ...
    return ( 
        <Container>
            ...
            <Row id="description_row">
                <span>A special NFT Collection that that come with 1/1 Hand Crafted IRL Blotter</span>
                <span>A Moonbirds Derivative Production</span>
                <span>{accountInfo.mintPrice/(10**18)} ETH per mint. Reserved to each moonbird owner</span>
            </Row>
            <Row id="visual_row">
